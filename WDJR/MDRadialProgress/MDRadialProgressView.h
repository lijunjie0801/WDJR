...
@property (assign, nonatomic) CGFloat progressTotal;

// The number of steps currently completed.
@property (assign, nonatomic) CGFloat progressCounter;
...
@property (strong, nonatomic) MDRadialProgressLabel *JinDulabel;

@property (nonatomic, strong) NSString *wanChen;
